...
Huffman.prototype.addControls = function() {
    ...
    $(this.btnReset).css('background-color','#0090C0').css('border-radius','10px').css('font-size','30px').css('outline','transparent');
    ...
    $(this.btnBuild).css('background-color','#0090C0').css('border-radius','10px').css('font-size','30px');

    this.lblText = addLabelToAlgorithmBar("Text:");
    
    this.txtText = addControlToAlgorithmBar("Text", "");
    this.controls.push(this.txtText);
    $(this.txtText).css('width','300px').css('height','30px');
}
